...
This capability defines frontend browsing, catalog refresh, duplicate booking conflict, and listing detail availability behavior for the current browse-and-book flow.
